...
test.describe('Footer', () => {
  ...
  test('Online chat support', { tag: '@smoke' }, async () => {
  ...
  test('Click "Terms of Service"', { tag: '@smoke' }, async () => {
  ...
  test('Click "Responsible Gaming"', { tag: '@smoke' }, async () => {
  ...
  test('Click "Self-Exclusion"', { tag: '@smoke' }, async () => {
  ...
  test('Click "Privacy & Management of Personal Data"', { tag: '@smoke' }, async () => {
    qase.comment(
  ...
  test('Accounts, Payouts & Bonuses', { tag: '@smoke' }, async () => {
  ...
  test('KYC Policies', { tag: '@smoke' }, async () => {
