...
test.describe('Main Page', () => {
  ...
  test("Check 'Search your game' input", { tag: '@smoke' }, async ({ tombRiches }) => {
  ...
  test('Check "Slots" button', { tag: '@smoke' }, async ({ tombRiches }) => {
  ...
  test('Check "Promotions" button', { tag: '@smoke' }, async ({ tombRiches }) => {
  ...
  test('Check "Bonuses" button', { tag: '@smoke' }, async ({ tombRiches }) => {
  ...
  test('Check "Live Casino" button', { tag: '@smoke' }, async ({ tombRiches }) => {
  ...
  test('Support button functionality', { tag: '@smoke' }, async ({ tombRiches }) => {
...
test.describe('Main Page', () => {
  ...
  test('Promo Block Check the take it button', { tag: '@smoke' }, async ({ tombRiches }) => {
  ...
  test('Promo Block check the buttons', { tag: '@smoke' }, async ({ tombRiches }) => {
  ...
  test('Provider Block "Get More" Button Navigation', { tag: '@smoke' }, async ({ tombRiches }) => {
